...
<big><a href="javascript:void(0)" onclick="abrirPdfReservaDetalhe('{$id}')" title="Detalhamento (Imprimir / Salvar PDF)"><i class="fa fa-file-pdf-o text-danger"></i></a></big>



<big><a href="javascript:void(0)" onclick="abrirPdfConsumoReserva('{$id}')" title="Detalhamento Consumo (Imprimir / Salvar PDF)"><i class="fa fa-file-pdf-o verde"></i></a></big>
