...
<a href="javascript:void(0)" onclick="gerarRelatorioEstoque()" style="position:absolute; right:30px" class="btn btn-success"><span class="fa fa-file-pdf-o"></span> Relatório</a>
