...
<div class="modal fade" id="modalForm" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	...
	<div class="modal-dialog modal-lg">
		...
		<a href="#" onclick="abrirPdfAssincrono('rel/reserva_prepare.php', {id: {$id}}, 'Gerando reserva em PDF...'); return false;">
...
<!-- Modal PDF Reserva -->
<div class="modal fade" id="modalReservaPdf" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	...
	<div class="modal-dialog" style="max-width: 520px; width: 95%;">
		...
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title">Reserva Salva</h4>
...
<script type="text/javascript">
	...
	$('#modalReservaPdf').on('shown.bs.modal', function(){
		var dialog = $(this).find('.modal-dialog');
		var offset = Math.max(20, (($(window).height() - dialog.outerHeight()) / 2));
		dialog.css('margin-top', offset + 'px');
	});
...
<script type="text/javascript">
	...
	function detalhamentoConsumo(){
		...
		abrirPdfAssincrono('rel/consumo_prepare.php', {id: id_reserva}, 'Gerando detalhamento de consumo...');
