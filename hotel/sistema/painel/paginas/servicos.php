...
<form method="post" id="formRelServicos">
...
<button type="button" style="position:absolute; right:30px" class="btn btn-success" onclick="gerarRelatorioServicos()"><span class="fa fa-file-pdf-o"></span> Relatório</button>
