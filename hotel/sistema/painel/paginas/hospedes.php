			...
			<form id="form" enctype="multipart/form-data">
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-8">
							<label>Foto</label>
							<input type="file" class="form-control" id="foto" name="foto" accept="image/*" onchange="carregarImg()">
						</div>
					...
					<input type="hidden" class="form-control" id="foto_antiga" name="foto_antiga">
			...
			<div class="modal-body">
				...
				<div class="row" style="margin-top: 0px">
					...
					<div class="col-md-12" style="margin-bottom: 5px">
						...
						<div align="center"><img src="images/sem-foto.png" id="foto_dados" width="200px"></div>
				...
				cache: false,
					<script type="text/javascript">
						function carregarImg() {
							...
							if (!file) {
								target.src = 'images/sem-foto.png';
								return;
							}
				contentType: false,
							var reader = new FileReader();
