...
<form method="post" id="formRelProdutos">
...
<button type="button" style="position:absolute; right:30px" class="btn btn-success" onclick="gerarRelatorioProdutos()"><span class="fa fa-file-pdf-o"></span> Relatório</button>
